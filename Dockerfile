...
RUN set -ex; \
    apt-get update; \
    apt install -y build-essential zlib1g-dev zlibc; \
    ##zlib1g-dev libncurses5-dev libgdbm-dev libnss3-dev libssl-dev libsqlite3-dev libreadline-dev libffi-dev wget libbz2-dev; \
